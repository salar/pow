...
(function() {
  ...
  module.exports = Configuration = (function() {
    ...
    Configuration.optionNames = ["bin", "dnsPort", "timeout", "workers", "domains", "hostRoot", "logRoot", "rvmPath"];
    ...
    Configuration.prototype.initialize = function(env) {
      var _base, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      this.env = env;
      this.bin = (_ref = env.POW_BIN) != null ? _ref : path.join(__dirname, "../bin/pow");
      this.dnsPort = (_ref1 = env.POW_DNS_PORT) != null ? _ref1 : 20560;
      this.timeout = (_ref2 = env.POW_TIMEOUT) != null ? _ref2 : 15 * 60;
      this.workers = (_ref3 = env.POW_WORKERS) != null ? _ref3 : 2;
      this.domains = (_ref4 = (_ref5 = env.POW_DOMAINS) != null ? _ref5 : env.POW_DOMAIN) != null ? _ref4 : "dev,silktest";
      this.domains = (_ref6 = typeof (_base = this.domains).split === "function" ? _base.split(",") : void 0) != null ? _ref6 : this.domains;
      this.allDomains = this.domains.concat([]);
      this.allDomains.push(/\d+\.\d+\.\d+\.\d+\.xip\.io$/, /[0-9a-z]{1,7}\.xip\.io$/);
      this.supportRoot = libraryPath("Application Support", "Pow");
      this.hostRoot = (_ref7 = env.POW_HOST_ROOT) != null ? _ref7 : path.join(this.supportRoot, "Hosts");
      this.logRoot = (_ref8 = env.POW_LOG_ROOT) != null ? _ref8 : libraryPath("Logs", "Pow");
      this.rvmPath = (_ref9 = env.POW_RVM_PATH) != null ? _ref9 : path.join(process.env.HOME, ".rvm/scripts/rvm");
